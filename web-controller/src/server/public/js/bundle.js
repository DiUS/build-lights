...
__$styleInject(".tab{min-width:100%}.tab ul.tab-nav{display:-webkit-box;display:-ms-flexbox;display:flex;height:2.5em;list-style:none}.tab ul.tab-nav li{border-top-left-radius:.4375em;border-top-right-radius:.4375em;border-bottom:.0625em solid #00b6f0;display:inline-block;-webkit-box-flex:1;-ms-flex:1;flex:1;line-height:2.5em;padding:0 .625em}.tab ul.tab-nav li a{color:#666;display:block;font-family:Roboto,sans-serif;font-size:1.125em;font-weight:700;text-transform:capitalize}.tab ul.tab-nav li.selected{border-bottom:none;border-left:.0625em solid #00b6f0;border-top:.0625em solid #00b6f0;border-right:.0625em solid #00b6f0}.tab ul.tab-nav li.selected a{color:#333}.tab ul.tab-nav li.selected:hover{background-color:transparent}.tab ul.tab-nav li:hover{background-color:#f5f5f5}.tab .tab-content{padding:.625em;border-left:.0625em solid #00b6f0;border-right:.0625em solid #00b6f0}.tab .tab-content div{display:none}.tab .tab-content div.shown{display:block}", undefined);
...
function representation(model) {
  var representation = 'Loading data...';

  if (tabChange$1(model)) {
    representation = tabChange(model);
  }

  display(representation);
}

function tabChange$1(model) {
  return model.tabChanged;
}
...
var model = {
  tools: [{ name: 'network', configuration: {}, active: true }, { name: 'jobs', configuration: {}, active: true }, { name: 'statistics', configuration: {}, active: false }],
  selectedTool: 'network'
};

function present(updatedData) {
...
function switchToTab(tabName, present$$1) {
  present({ tabChange: tabName }, present$$1 || present);
  return false;
}
...
var TabContent = function TabContent(tabInfo) {
  var displayClass = tabInfo.active ? 'shown' : '';
  return bp0$2(displayClass, tabInfo.name);
};
...
var Tab = function Tab(model) {
  ...
  return bp0([bp1(tabs), bp2(tabContent)]);
};
